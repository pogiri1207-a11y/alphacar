...
const BASE_URL = process.env.NEXT_PUBLIC_BASE_URL || "https://inflictable-introvertedly-merrie.ngrok-free.dev";
...
function LoginContent() {
  ...
  const handleGoogleLogin = () => {
    ...
    const REDIRECT_URI = "https://192.168.56.200:31008/mypage";
  ...
  const handleKakaoLogin = () => {
    ...
    const REDIRECT_URI = `${BASE_URL}/mypage`;
  ...
  const handleEmailLogin = async () => {
    ...
    try {
      const res = await fetch("https://192.168.56.200:31008/api/auth/login", {
        method: "POST",
